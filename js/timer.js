...
var time = 1000 * 60 * 1.5 //change the last number for the number of minutes (to msec)
...
function update(timeleft) { // called every step to update the visible countdown
        ...
        document.getElementById('navbar').backgroundImage = "linear-gradient(left, #FFD51A 50%, #FAC815 50%);";
}
